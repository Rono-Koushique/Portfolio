    ...
    return (
        <div className={addClass}>
            <div
                ...
                className="w-6 aspect-square flex flex-col justify-between overflow-hidden cursor-pointer"
            >
                <div
                    className={`relative top-0 w-full h-1 bg-teal-300 rounded-full duration-200 ease-in-out ${
                        open
                ...
                <div
                    className={`relative bottom-0 w-full h-1 bg-teal-300 rounded-full duration-200 ease-in-out ${
                        open
                            ? "scale-x-[1.35] -rotate-45 bottom-1/2 translate-y-1/2"
                            : ""
                    }`}
                />
            </div>
