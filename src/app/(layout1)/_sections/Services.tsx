...
import VertAnime from "../_components/extra/VertAnime";
...
export default function Services({ services }: Props) {
    return (
        <section className="flex py-20 relative">
            ...
            <div className="flex flex-col lg:items-center text-white font-roboto font-normal px-10 lg:px-0 max-w-screen-xl mx-auto">
...
function ServiceCard({ service }: ServiceCardProps) {
    return (
        ...
        >
            <div className="px-6 py-6 h-full flex flex-col lg:items-center lg:text-center">
                <Icon className="text-[2rem] text-teal-500" icon={service.icon} />
                <h1 className="mt-4 text-2xl sm:text-3xl text-teal-500 font-bold">
                    {service.title}
                </h1>
                <p className="mt-auto pt-4 text-sm leading-loose font-light text-neutral-300">
                    {service.description}
                </p>
